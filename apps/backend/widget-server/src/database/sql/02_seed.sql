...
VALUES ('10000000-0000-4000-8000-000000000001', 'default', '默认租户', '平台管理员', '13800000000', 1, NULL)
ON CONFLICT DO NOTHING;

-- ---------- 权限（菜单 + 按钮） ----------
INSERT INTO sys_permission (id, permission_code, permission_name, resource_type, parent_id, path, sort_order) VALUES
  ('20000000-0000-4000-8000-000000000001', 'menu:scene',        '场景管理',     'MENU',   NULL, '/scenes',        10),
  ('20000000-0000-4000-8000-000000000002', 'scene:view',        '查看场景',     'BUTTON', '20000000-0000-4000-8000-000000000001', '/api/v1/scenes',         11),
  ('20000000-0000-4000-8000-000000000003', 'scene:create',      '创建场景',     'BUTTON', '20000000-0000-4000-8000-000000000001', '/api/v1/scenes',         12),
  ('20000000-0000-4000-8000-000000000004', 'scene:edit',        '编辑场景',     'BUTTON', '20000000-0000-4000-8000-000000000001', '/api/v1/scenes/:id',     13),
  ('20000000-0000-4000-8000-000000000005', 'scene:delete',      '删除场景',     'BUTTON', '20000000-0000-4000-8000-000000000001', '/api/v1/scenes/:id',     14),
  ('20000000-0000-4000-8000-000000000006', 'scene:publish',     '发布场景',     'BUTTON', '20000000-0000-4000-8000-000000000001', '/api/v1/scenes/:id/publish', 15),
  ('20000000-0000-4000-8000-000000000010', 'menu:component',    '组件库',       'MENU',   NULL, '/components',    20),
  ('20000000-0000-4000-8000-000000000011', 'component:view',    '查看组件',     'BUTTON', '20000000-0000-4000-8000-000000000010', '/api/v1/components',     21),
  ('20000000-0000-4000-8000-000000000012', 'component:manage',  '管理组件',     'BUTTON', '20000000-0000-4000-8000-000000000010', '/api/v1/components',     22),
  ('20000000-0000-4000-8000-000000000020', 'menu:asset',        '资产管理',     'MENU',   NULL, '/assets',        30),
  ('20000000-0000-4000-8000-000000000021', 'file:upload',       '上传文件',     'BUTTON', '20000000-0000-4000-8000-000000000020', '/api/v1/files/upload',   31),
  ('20000000-0000-4000-8000-000000000022', 'file:delete',       '删除文件',     'BUTTON', '20000000-0000-4000-8000-000000000020', '/api/v1/files/:id',      32),
  ('20000000-0000-4000-8000-000000000030', 'menu:data',         '数据接入',     'MENU',   NULL, '/data-sources',  40),
  ('20000000-0000-4000-8000-000000000031', 'datasource:view',   '查看数据源',   'BUTTON', '20000000-0000-4000-8000-000000000030', '/api/v1/data-sources',   41),
  ('20000000-0000-4000-8000-000000000032', 'datasource:manage', '管理数据源',   'BUTTON', '20000000-0000-4000-8000-000000000030', '/api/v1/data-sources',   42),
  ('20000000-0000-4000-8000-000000000033', 'device:view',       '查看设备',     'BUTTON', '20000000-0000-4000-8000-000000000030', '/api/v1/devices',        43),
  ('20000000-0000-4000-8000-000000000034', 'device:manage',     '管理设备',     'BUTTON', '20000000-0000-4000-8000-000000000030', '/api/v1/devices',        44),
  ('20000000-0000-4000-8000-000000000040', 'menu:system',       '系统管理',     'MENU',   NULL, '/system',        50),
  ('20000000-0000-4000-8000-000000000041', 'system:user:manage','用户管理',     'BUTTON', '20000000-0000-4000-8000-000000000040', '/api/v1/users',          51),
  ('20000000-0000-4000-8000-000000000042', 'system:role:manage','角色管理',     'BUTTON', '20000000-0000-4000-8000-000000000040', '/api/v1/roles',          52),
  ('20000000-0000-4000-8000-000000000043', 'system:log:view',   '日志查看',     'BUTTON', '20000000-0000-4000-8000-000000000040', '/api/v1/operation-logs', 53)
ON CONFLICT DO NOTHING;

-- ---------- 角色 ----------
INSERT INTO sys_role (id, tenant_id, role_code, role_name, description, is_system) VALUES
  ('30000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000001', 'SUPER_ADMIN',  '超级管理员', '拥有平台全部权限', TRUE),
  ('30000000-0000-4000-8000-000000000002', '10000000-0000-4000-8000-000000000001', 'TENANT_ADMIN', '租户管理员', '管理本租户全部业务与成员', TRUE),
  ('30000000-0000-4000-8000-000000000003', '10000000-0000-4000-8000-000000000001', 'DEVELOPER',    '开发者',     '可构建场景、管理组件与数据源', TRUE),
  ('30000000-0000-4000-8000-000000000004', '10000000-0000-4000-8000-000000000001', 'VIEWER',       '访客',       '仅可浏览已发布场景', TRUE)
ON CONFLICT DO NOTHING;

-- 超级管理员与租户管理员：全部权限
INSERT INTO sys_role_permission (role_id, permission_id)
SELECT '30000000-0000-4000-8000-000000000001', id FROM sys_permission
ON CONFLICT DO NOTHING;
INSERT INTO sys_role_permission (role_id, permission_id)
SELECT '30000000-0000-4000-8000-000000000002', id FROM sys_permission
ON CONFLICT DO NOTHING;

-- 开发者：场景、组件、资产、数据源全量 + 设备只读
INSERT INTO sys_role_permission (role_id, permission_id)
SELECT '30000000-0000-4000-8000-000000000003', id FROM sys_permission
...
-- 访客：只读
INSERT INTO sys_role_permission (role_id, permission_id)
SELECT '30000000-0000-4000-8000-000000000004', id FROM sys_permission
...
INSERT INTO sys_user (id, tenant_id, username, password, real_name, email, phone, status) VALUES
  ('40000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000001', 'admin',
   '$2b$10$uSJLNozMpe3R0XkUkEJ/Ze/2Kp/S5UspcZHcmrDzw.epSzrrqwVxy', '平台管理员', 'admin@example.com', '13800000001', 1),
  ('40000000-0000-4000-8000-000000000002', '10000000-0000-4000-8000-000000000001', 'dev',
   '$2b$10$jHWkX9N6MbLfcfxpwybe8u.mhjNBNLj.D.KYK35v8hm/pAieJN4l.', '孪生开发者', 'dev@example.com', '13800000002', 1),
  ('40000000-0000-4000-8000-000000000003', '10000000-0000-4000-8000-000000000001', 'viewer',
...
VALUES ('40000000-0000-4000-8000-000000000000', '10000000-0000-4000-8000-000000000001', '__system__',
...
INSERT INTO biz_component (id, tenant_id, name, description, component_type, category, thumbnail, config_schema, is_public, version, creator_id) VALUES
  ('50000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000001', '三维模型', '加载 GLTF/GLB/FBX 精细模型，支持 LOD 与材质替换', 'MODEL_3D', 'SCENE_3D', NULL,
   ...
   TRUE, '1.0.0', '40000000-0000-4000-8000-000000000000'),
  ('50000000-0000-4000-8000-000000000002', '10000000-0000-4000-8000-000000000001', '倾斜摄影/3D Tiles', '加载 3D Tiles 数据集，支持样式与压平', 'TILES_3D', 'SCENE_3D', NULL,
   ...
   TRUE, '1.0.0', '40000000-0000-4000-8000-000000000000'),
  ('50000000-0000-4000-8000-000000000003', '10000000-0000-4000-8000-000000000001', 'POI 标注点', '地理位置标注，支持图标、文字与弹窗', 'POI', 'SCENE_3D', NULL,
   ...
   TRUE, '1.0.0', '40000000-0000-4000-8000-000000000000'),
  ('50000000-0000-4000-8000-000000000004', '10000000-0000-4000-8000-000000000001', '环境特效', '雨、雪、雾等环境粒子特效', 'PARTICLE', 'SCENE_3D', NULL,
   ...
   TRUE, '1.0.0', '40000000-0000-4000-8000-000000000000'),
  ('50000000-0000-4000-8000-000000000010', '10000000-0000-4000-8000-000000000001', '折线图', '时序趋势折线图，支持多系列与面积填充', 'CHART_LINE', 'CHART', NULL,
   ...
   TRUE, '1.0.0', '40000000-0000-4000-8000-000000000000'),
  ('50000000-0000-4000-8000-000000000011', '10000000-0000-4000-8000-000000000001', '指标卡', '关键指标展示，支持趋势与单位', 'METRIC_CARD', 'UI', NULL,
   ...
   TRUE, '1.0.0', '40000000-0000-4000-8000-000000000000'),
  ('50000000-0000-4000-8000-000000000012', '10000000-0000-4000-8000-000000000001', '文本标签', '大屏文字，支持发光与描边', 'TEXT', 'UI', NULL,
   ...
   TRUE, '1.0.0', '40000000-0000-4000-8000-000000000000'),
  ('50000000-0000-4000-8000-000000000013', '10000000-0000-4000-8000-000000000001', '面板容器', '科技感边框容器，用于分组承载其他组件', 'PANEL', 'UI', NULL,
...
INSERT INTO biz_scene (id, tenant_id, name, description, scene_type, engine_config, layout, status, version, publish_version, creator_id) VALUES
  ('60000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000001', '智慧园区数字孪生',
   ...
   1, 3, 2, '40000000-0000-4000-8000-000000000001'),
  ('60000000-0000-4000-8000-000000000002', '10000000-0000-4000-8000-000000000001', '变电站设备监测',
   ...
   0, 1, NULL, '40000000-0000-4000-8000-000000000002')
ON CONFLICT DO NOTHING;

-- ---------- 示例场景的 3D 组件实例（避免编辑器/预览三维画布空白）----------
-- 智慧园区（HYBRID）：锚点 (116.397428, 39.90923) 叠加一个 POI 标注 + 降雨粒子特效。
INSERT INTO biz_scene_component (id, scene_id, component_id, name, component_config, position, layer_id, sort_order, visible, locked, created_at, updated_at)
VALUES
  ('62000000-0000-4000-8000-000000000001',
   '60000000-0000-4000-8000-000000000001',
   '50000000-0000-4000-8000-000000000003',
   '主变压器 TRANS-001',
   '{"label":"主变压器 TRANS-001","color":"#ff4d4f","scaleByDistance":true}'::jsonb,
   '{"cartographic":{"longitude":116.397428,"latitude":39.90923,"height":80}}'::jsonb,
   'layer-gis', 0, true, false, NOW(), NOW()),
  ('62000000-0000-4000-8000-000000000002',
   '60000000-0000-4000-8000-000000000001',
   '50000000-0000-4000-8000-000000000004',
   '园区降雨特效',
   '{"effect":"rain","intensity":0.35}'::jsonb,
   '{}'::jsonb,
   'layer-model', 1, true, false, NOW(), NOW())
...
INSERT INTO biz_scene_version (id, scene_id, version_no, snapshot_data, change_log, creator_id) VALUES
  ('61000000-0000-4000-8000-000000000001', '60000000-0000-4000-8000-000000000001', 1,
   '{"config":{},"components":[],"layout":{"version":"1.0.0","nodes":[],"events":[]}}'::jsonb, '初始版本', '40000000-0000-4000-8000-000000000001'),
  ('61000000-0000-4000-8000-000000000002', '60000000-0000-4000-8000-000000000001', 2,
   '{"config":{},"components":[],"layout":{"version":"1.0.0","nodes":[],"events":[]}}'::jsonb, '新增能耗趋势图与指标卡', '40000000-0000-4000-8000-000000000001')
ON CONFLICT DO NOTHING;

-- ---------- 示例模板 ----------
INSERT INTO biz_template (id, tenant_id, name, description, category, template_data, is_public, creator_id) VALUES
  ('70000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000001', '智慧园区模板',
   '含园区底图、楼宇分层与运行指标面板', '智慧园区',
   '{"config":{},"components":[],"layout":{"version":"1.0.0","nodes":[],"events":[]}}'::jsonb, TRUE, '40000000-0000-4000-8000-000000000001'),
  ('70000000-0000-4000-8000-000000000002', '10000000-0000-4000-8000-000000000001', '智能工厂模板',
   '产线设备布局与生产节拍看板', '智能制造',
   '{"config":{},"components":[],"layout":{"version":"1.0.0","nodes":[],"events":[]}}'::jsonb, TRUE, '40000000-0000-4000-8000-000000000001')
ON CONFLICT DO NOTHING;
...
INSERT INTO biz_data_source (id, tenant_id, name, type, config, status, creator_id) VALUES
  ('80000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000001', '园区业务库', 'PG',
   '{"host":"localhost","port":5432,"database":"digital_twin","username":"postgres","password":"root"}'::jsonb, 1, '40000000-0000-4000-8000-000000000001'),
  ('80000000-0000-4000-8000-000000000002', '10000000-0000-4000-8000-000000000001', '设备遥测 MQTT', 'MQTT',
   '{"url":"mqtt://localhost:1883","clientId":"dt-platform","topic":"device/+/telemetry","username":"","password":""}'::jsonb, 0, '40000000-0000-4000-8000-000000000001'),
  ('80000000-0000-4000-8000-000000000003', '10000000-0000-4000-8000-000000000001', '第三方能耗接口', 'HTTP',
   '{"baseUrl":"https://api.example.com","method":"GET","path":"/energy/latest","headers":{}}'::jsonb, 1, '40000000-0000-4000-8000-000000000002')
ON CONFLICT DO NOTHING;
...
INSERT INTO iot_device (id, tenant_id, device_code, device_name, device_type, protocol, connection_config, status, last_online_at) VALUES
  ('90000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000001', 'TRANS-001', '1 号主变压器', '变压器', 'MQTT',
   '{"topic":"device/TRANS-001/telemetry","qos":1}'::jsonb, 1, NOW()),
  ('90000000-0000-4000-8000-000000000002', '10000000-0000-4000-8000-000000000001', 'FAN-002', '2 号冷却风机', '风机', 'MODBUS',
   '{"host":"192.168.1.30","port":502,"slaveId":2}'::jsonb, 1, NOW()),
  ('90000000-0000-4000-8000-000000000003', '10000000-0000-4000-8000-000000000001', 'ENV-003', '环境监测终端', '环境传感器', 'OPC-UA',
...
INSERT INTO iot_device_property (device_id, property_code, property_name, property_type, unit, min_value, max_value, default_value) VALUES
  ('90000000-0000-4000-8000-000000000001', 'temperature', '绕组温度', 'NUMBER', '°C', 0, 150, '65'),
  ('90000000-0000-4000-8000-000000000001', 'load',        '负载率',   'NUMBER', '%',  0, 120, '70'),
  ('90000000-0000-4000-8000-000000000002', 'speed',       '转速',     'NUMBER', 'rpm', 0, 3000, '1450'),
  ('90000000-0000-4000-8000-000000000002', 'vibration',   '振动',     'NUMBER', 'mm/s', 0, 20, '2.5'),
  ('90000000-0000-4000-8000-000000000003', 'humidity',    '湿度',     'NUMBER', '%RH', 0, 100, '55')
ON CONFLICT DO NOTHING;
...
INSERT INTO iot_alert_rule (id, tenant_id, device_id, property_code, rule_name, condition, threshold, alert_level, notify_channel, enabled) VALUES
  ('a0000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000001', '90000000-0000-4000-8000-000000000001',
